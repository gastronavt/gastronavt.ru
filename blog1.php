...
$landingBean = BeanFactory::getBean('lngng_landings', 'c57ab24b-908b-b16b-288e-65a04ba09a56');
echo '1111';die();
?>
<html lang="en">
	<head>
	            						...
	            						<div class="wsmegamenu w-75 clearfix">
	             							<div class="container">
	               								<div class="row">
									                ...
									                <!-- MEGAMENU LINKS -->
	               									<ul class="col-md-12 col-lg-3 link-list">
									                    <li class="fst-li"><a href="demo-6.html">SaaS Service 1</a></li>
									                    <li><a href="demo-7.html">Digital Service 1</a></li>
									                    <li><a href="demo-8.html">Social Media Marketing</a></li>
									                ...
									                <!-- MEGAMENU LINKS -->
	               									<ul class="col-md-12 col-lg-3 link-list">
									                    <li class="fst-li"><a href="demo-11.html">Desktop Software 1</a></li>
									                    ...
									                    <li><a href="demo-15.html">Software 2</a></li>    			           
									                </ul>

									                <!-- MEGAMENU LINKS -->
	               									<ul class="col-md-12 col-lg-3 link-list">
									                    <li class="fst-li"><a href="demo-16.html">App Showcase 3</a></li>
					 		...
					 		<div class="col">
					 			<div class="blog-1-post mb-50 wow fadeInUp">
									...
									<div class="blog-post-txt">
										...
										<!-- Post Link -->
										<h5 class="h5-sm">
											<a href="single-post.html">Integer urna turpis donec ipsum a porta justo risus auctor</a>
										</h5>
					 		...
					 		<div class="col">
					 			<div class="blog-1-post mb-50 wow fadeInUp">
									...
									<div class="blog-post-txt">
										...
										<!-- Post Link -->
										<h5 class="h5-sm">
											<a href="single-post.html">Semper lacus a cursus feugiat</a>
										</h5>
										...
										<!-- Post Meta -->
										<div class="post-meta"><p>Extensions &ensp;|&ensp; 3 Comments</p></div>	
					 		...
					 		<div class="col">
					 			<div class="blog-1-post mb-50 wow fadeInUp">
									...
									<div class="blog-post-txt">
										...
										<!-- Post Link -->
										<h5 class="h5-sm">
											<a href="single-post.html">Neque lectus porta MacOs</a>
										</h5>
										...
										<!-- Post Meta -->
										<div class="post-meta"><p>OLMO News &ensp;|&ensp; 24 Comments</p></div>	
					 		...
					 		<div class="col">
					 			<div class="blog-1-post mb-50 wow fadeInUp">
									...
									<div class="blog-post-txt">
										...
										<!-- Post Link -->
										<h5 class="h5-sm">
											<a href="single-post.html">An aliquam justo suscipit congue augue egestas volutpat 
										...
										<!-- Post Meta -->
										<div class="post-meta"><p>Community &ensp;|&ensp; 21 Comments</p></div>	
					 		...
					 		<div class="col">
					 			<div class="blog-1-post mb-50 wow fadeInUp">
									...
									<div class="blog-post-txt">
										...
										<!-- Post Link -->
										<h5 class="h5-sm">
											<a href="single-post.html">Purus ipsum primis and 90's and ligula egestas suscipit</a>
										</h5>
										...
										<!-- Post Meta -->
										<div class="post-meta"><p>OLMO News &ensp;|&ensp; 32 Comments</p></div>	
