...
<body>
    ...
    <div class="wrapper" style="background:<?=$wrapper_background?>;" > 
		<?php 
			...
			if( App::$send_404 ){
				include CORE_FOLDER.'/application/views/postomat/404_view.php';
			} else{
				if( !$router ){
					return false;
				}
	...
	<?php include CORE_FOLDER.'/application/views/postomat/widget/share_modal.php'; //кнопка Поделиться - модальное окно?>
...
<?php include CORE_FOLDER.'/application/views/postomat/widget/promocod_modal.php'; //модальное окно с промокодом ?>
</body>
