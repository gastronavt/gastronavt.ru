...
<?php include CORE_FOLDER.'/application/views/widget/error_modal.php'; //модальное окно для вывода ошибок ?>
<?php include CORE_FOLDER.'/application/views/widget/modal.php'; //рекламные модальные окна?>
<?php if(App::$router->getAction() == 'index') {
	include CORE_FOLDER.'/application/views/widget/products_modal.php'; //Модальные окна продуктов
} ?>

<?php if(App::$router->getAction() == 'lead') {
	include CORE_FOLDER.'/application/views/widget/gift_modal.php'; //Модальные окна всплывющего подарка в корзине
} ?>

<?php 
	if(App::$current_landing->id != '4d9a18d4-ce17-1e34-d602-5e1dbbd7f258'){
		include CORE_FOLDER.'/application/views/widget/snow.php'; //падающий снег
	}
?>
