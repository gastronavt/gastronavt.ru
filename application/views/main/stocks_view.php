...
<div class="container" <?php if(!empty(App::$current_aggregator)){ ?> style="margin-top:70px;" <?php } ?>>
	...
	<div class="row">
		<div class="col-12 mb-2">
			<div class="badge-new me-2 mb-3 shadow-sm"><a href="<?=NFfunctions::getSiteProtocol()?><?=$_SERVER['HTTP_HOST']?>/main/news" style="text-decoration:none;">Все</a></div>
			<div class="badge-new active me-2 mb-3 shadow-sm"><a href="<?=NFfunctions::getSiteProtocol()?><?=$_SERVER['HTTP_HOST']?>/main/stocks" style="text-decoration:none;">Только акции</a></div>
			<div class="badge-new me-2 mb-3 shadow-sm"><a href="<?=NFfunctions::getSiteProtocol()?><?=$_SERVER['HTTP_HOST']?>/main/news?type=only_news" style="text-decoration:none;">Только новости</a></div>
		</div>
	</div>
	<div class="row">
		<?php 
